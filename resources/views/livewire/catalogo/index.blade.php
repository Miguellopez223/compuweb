...
@elseif($apiError)
<div class="flex flex-col items-center justify-center min-h-[70vh] text-center px-4">
    <div class="w-24 h-24 rounded-3xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mb-6">
    ...
    <h2 class="text-3xl font-extrabold text-white mb-2">Sin conexión</h2>
    <p class="text-zinc-500 mb-6 max-w-sm">No pudimos conectarnos al servidor. Verifica tu conexión e intenta de nuevo.</p>
    <button wire:click="$refresh"
            class="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-bold rounded-xl transition shadow-lg shadow-indigo-900/40">
        Reintentar
    </button>
</div>
                ...
                <div class="flex flex-col flex-1 p-4">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <a href="https://wa.me/{{ $waPhone }}?text={{ $waMsg }}"
                           target="_blank"
                           class="flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-bold transition
                                  bg-green-600/90 hover:bg-green-500 text-white border border-green-500/30 hover:border-green-400/50
                                  shadow-sm hover:shadow-green-900/40">
                        ...
                        <button x-data
                                ...
                                class="flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-bold transition-all
