<div class="max-w-5xl mx-auto px-4 sm:px-6 py-10">
    ...
    <div class="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p class="text-zinc-400 mb-6">Este producto no existe o ya no está disponible.</p>
    ...
    <nav class="flex items-center gap-2 text-sm text-zinc-500 mb-8">
        <a href="{{ route('catalogo', $slug) }}" class="hover:text-white transition">Catálogo</a>
        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-center gap-4 mb-5">
                ...
                <span class="px-3 py-1 rounded-full text-xs font-semibold
                             {{ ($producto['stock'] ?? 0) > 0 ? 'bg-emerald-500/10 text-emerald-400' : 'bg-red-500/10 text-red-400' }}">
            ...
            <div class="space-y-3 mt-auto">
                @php
                    $waMsg = urlencode("Hola *{$tienda['nombre']}*, quiero información sobre:\n\n• *{$producto['nombre']}* — Bs. " . number_format($producto['precio'] ?? 0, 2) . "\n\n¿Está disponible?");
            ...
            <div class="mt-auto p-4 bg-zinc-900 border border-zinc-700 rounded-xl text-center">
                <p class="text-zinc-400 font-medium">Este producto no está disponible actualmente</p>
